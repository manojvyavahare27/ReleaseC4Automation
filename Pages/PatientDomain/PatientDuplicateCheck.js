class PatientDuplicateCheck
{
    constructor(page)
    {
        ...
        //this.dropdown_photo_Identification=page.getByTestId('photoIdentification').getByLabel('Open')
         this.dropdown_photo_Identification=page.locator("xpath=//input[@id='photoIdentification']")
        ...
        this.dropdown_issuing_Country=page.locator("xpath=//input[@id='issuingCountry']")
       ...
       this.dropdown_is_baby_born_inthe_hospital= page.locator("xpath=//input[@id='babyBornInHospital']") 
